...
# Modèle linéaire : étude de l’expression des gènes pour le traitement T3 et le traitement T1 à 6h
...
La p-valeur est égale 0.2798 et est supérieure à 0.05, on ne rejette don pas H0 au risque de 5%, on accepte donc le sous_modèle.
