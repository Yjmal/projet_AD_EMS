...
```{r}
T36HR2_binomial = R2[-c(6,12)] # Toutes les variables du réplicat 2 sauf les temps 6

T36HR2_binomial$T3_6h_R2[T36HR2_binomial$T3_6h_R2>1] = 1
T36HR2_binomial$T3_6h_R2[T36HR2_binomial$T3_6h_R2<(-1)] = 0
glm.T36HR2<-glm(T3_6h_R2~.,data=T36HR2_binomial,family=binomial(link="logit"))
summary(glm.T36HR2)
```
...
T1R2_T3 = T1R2
T1R2_T3["T3_6h_R2"] = data$T3_6h_R2
T36HR2_binomial = T1R2_T3 # Seulement T1R2 (et la variable a expliqué : T3_6h_R2)
...
```{python}
Defaultpy=r.T36HR2_binomial
y=Defaultpy["T3_6h_R2"]
x=Defaultpy[Defaultpy.columns.drop("T3_6h_R2")]
...
Y = data["T1_6h_R2"]
Y[Y>1] = "sur-exprime"
Y[Y<(-1) & Y!="sur-exprime"] = "sous-exprime"
...
dfmodel["Y"] = Y
dfmodel = dfmodel[-(6)]
model <- multinom(Y ~ ., data = dfmodel)
summary(model)

step.backward <- step(model, trace=0)
stepAIC(glm.T36HR2, direction=c("forward"),p=2, trace=0) # AIC
```

backward : T1_1h_R2, T1_2h_R2, T1_3h_R2, T1_4h_R2, T1_5h_R2, \
T2_1h_R2, T2_2h_R2, T2_3h_R2, T2_6h_R2,\
T3_1h_R2, T3_2h_R2, T3_3h_R2, T3_5h_R2, T3_6h_R2

forward : \
T2_1h_R2, T2_2h_R2, T2_3h_R2, T2_4h_R2, T2_5h_R2\
